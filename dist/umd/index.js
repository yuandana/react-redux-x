(function (global, factory) {
  ...
  var createStore = function createStore(module, preloadedState, enhancer) {
    ...
    var reduxModuleEnhancer = redux.applyMiddleware(actionMiddleware); // 合并 enhancer 和 redux-module 集成 actionMiddleware

    if (enhancer !== undefined) {
      // compose 原有的 applyMiddleware 或者 enhancer
      // 并保证 actionMiddleware 在第一位
      enhancer = redux.compose(reduxModuleEnhancer, enhancer);
    } else {
